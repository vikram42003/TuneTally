  ...
  return (
    <section className="bg-spotify-dark">
      <div className="layout-container py-8 text-center">
        The app only stores auth token, profile data, top songs and top artists for caching purposes, but everything gets auto deleted after a duration of 1 hour.
        <br />
