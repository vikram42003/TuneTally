  ...
  return (
    <div className="flex items-center pt-4 gap-2">
      ...
      <div className="flex flex-13/24 items-center gap-2">
        <Link to={song.external_urls} className="block min-h-[3rem] min-w-[3rem] max-h-[3rem] max-w-[3rem]">
          <img
        ...
        <div>
          ...
          <div>
            {song.artists.map((a, idx) => (
              <span key={a.id}>
                <Link to={a.external_urls} className="text-spotify-text-gray hover:underline text-[0.9em]">
                  {a.name}
                </Link>
